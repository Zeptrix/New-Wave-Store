...
class ProductList: ObservableObject {
    ...
    @Published var products: [Product] =
        [Product(name: "NW-PC", description: "New Wave PC", picture: "NW-PC", price: 3999.99, quantity: 10),
        Product(name: "nwPhone", description: "nwPhone", picture: "nwPhone", price: 999.99, quantity: 50),
